...
export const metadata: Metadata = {
  ...
  description: 'Synchronize UI overlays with browser history for natural back/forward navigation.',
};
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          The <code>id</code> parameter is <strong>required</strong>. It must be a stable string that uniquely identifies the overlay instance on the page.
        </p>
        <CodeBlock
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <h3 className="text-lg font-medium pt-4">Implementation Example</h3>
          <CodeBlock
            fileName="App.tsx"
    ...
    <>
      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-neutral-700 dark:text-neutral-300">
          <li>
            <strong>Stable IDs:</strong> Always provide a hardcoded string ID. Avoid using random IDs or IDs generated during render (like <code>useId</code>) if they might change when the component tree shifts.
          </li>
          <li>
            <strong>Page Scoping:</strong> Prefix your IDs with the page or feature name (e.g., <code>&apos;login:otp-modal&apos;</code>) to avoid collisions with other overlays in the history stack.
          </li>
          <li>
            <strong>LIFO Order:</strong> The hook handles stacking automatically using a history-based stack model. Back button will always close the most recently opened overlay.
          </li>
        </ul>
      </div>
    </div>
